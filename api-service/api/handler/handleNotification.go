...
func HandlerGetMyNotifications(w http.ResponseWriter, r *http.Request) {
	...
	notis, err := conf.DB_Queries.GetAllNotifications(r.Context(), database.GetAllNotificationsParams{
...
func HandlerSeenNotification(w http.ResponseWriter, r *http.Request) {
	...
	err = conf.DB_Queries.MarkSeenNotification(r.Context(), database.MarkSeenNotificationParams{

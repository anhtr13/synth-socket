...
import (
	...
	"github.com/anhtr13/synth-socket/api/internal/api/guard"
	"github.com/anhtr13/synth-socket/api/internal/api/middleware"
)
...
func RegisterRoutes() http.Handler {
	...
	router.HandleFunc("GET /room/all/{room_id}", guard.Auth(HandleGetRoomData))
